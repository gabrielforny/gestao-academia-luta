...
function FaixasComponent_Conditional_19_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th");
    \u0275\u0275text(1, "Modalidade");
    \u0275\u0275elementEnd();
...
function FaixasComponent_Conditional_19_For_20_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const faixa_r5 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(faixa_r5.nomeModalidade);
  }
}
function FaixasComponent_Conditional_19_For_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275template(13, FaixasComponent_Conditional_19_For_20_Conditional_13_Template, 2, 1, "td", 30);
    ...
    \u0275\u0275text(19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "td")(21, "div", 31)(22, "button", 32);
    \u0275\u0275listener("click", function FaixasComponent_Conditional_19_For_20_Template_button_click_22_listener() {
      const faixa_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.abrirModal(faixa_r5));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(23, "svg", 33);
    \u0275\u0275element(24, "path", 34)(25, "path", 35);
    \u0275\u0275elementEnd()();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(26, "button", 36);
    \u0275\u0275listener("click", function FaixasComponent_Conditional_19_For_20_Template_button_click_26_listener() {
      const faixa_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.remover(faixa_r5.id));
    });
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(27, "svg", 33);
    \u0275\u0275element(28, "polyline", 37)(29, "path", 38)(30, "path", 39)(31, "path", 40)(32, "path", 41);
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("title", ctx_r2.modalidadeId() ? "Arrastar para reordenar" : "Selecione uma modalidade para reordenar");
    \u0275\u0275advance();
    \u0275\u0275styleProp("opacity", ctx_r2.modalidadeId() ? 1 : 0.3);
    \u0275\u0275advance(8);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(13, !ctx_r2.modalidadeId() ? 13 : -1);
    \u0275\u0275advance(2);
...
function FaixasComponent_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(8, "Nome");
    \u0275\u0275elementEnd();
    \u0275\u0275template(9, FaixasComponent_Conditional_19_Conditional_9_Template, 2, 0, "th");
    \u0275\u0275elementStart(10, "th");
    \u0275\u0275text(11, "Meses m\xEDn.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "th");
    \u0275\u0275text(13, "Presen\xE7as m\xEDn.");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(19, FaixasComponent_Conditional_19_For_20_Template, 33, 11, "tr", 19, _forTrack0);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(9);
    \u0275\u0275conditional(9, !ctx_r2.modalidadeId() ? 9 : -1);
    \u0275\u0275advance(10);
    \u0275\u0275repeater(ctx_r2.faixas());
  }
}
function FaixasComponent_Conditional_20_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1, "Nenhuma gradua\xE7\xE3o cadastrada para esta modalidade.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "button", 43);
    \u0275\u0275listener("click", function FaixasComponent_Conditional_20_Conditional_1_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.abrirModal());
    });
    \u0275\u0275text(3, "+ Criar nova gradua\xE7\xE3o");
    \u0275\u0275elementEnd();
  }
}
function FaixasComponent_Conditional_20_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1, "Nenhuma gradua\xE7\xE3o cadastrada. Selecione uma modalidade para criar a primeira.");
    \u0275\u0275elementEnd();
  }
}
function FaixasComponent_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, FaixasComponent_Conditional_20_Conditional_1_Template, 4, 0)(2, FaixasComponent_Conditional_20_Conditional_2_Template, 2, 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275conditional(1, ctx_r2.modalidadeId() ? 1 : 2);
  }
}
...
function FaixasComponent_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6, "\u2715");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(7, FaixasComponent_Conditional_21_Conditional_7_Template, 2, 1, "div", 48);
    ...
    \u0275\u0275elementStart(9, "div", 50)(10, "div", 7)(11, "label", 8);
    \u0275\u0275text(12, "Nome *");
    \u0275\u0275elementEnd();
    \u0275\u0275element(13, "input", 51);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div", 52)(15, "label", 8);
    \u0275\u0275text(16, "Cor");
    \u0275\u0275elementEnd();
    \u0275\u0275element(17, "input", 53);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "div", 50)(19, "div", 7)(20, "label", 8);
    \u0275\u0275text(21, "Ordem");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r2.editandoId() ? "Editar Gradua\xE7\xE3o" : "Nova Gradua\xE7\xE3o");
    \u0275\u0275advance(3);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FaixasComponent, selectors: [["app-faixas"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 22, vars: 4, consts: [[1, "page-container"], [1, "page-header"], [1, "page-title"], [1, "header-actions"], ["routerLink", "registrar", 1, "btn-secondary"], [1, "btn-primary", 3, "click", "disabled"], [1, "filters-row"], [1, "form-group"], [1, "form-label"], [1, "form-input", 2, "max-width", "300px", 3, "ngModelChange", "ngModel"], ["value", ""], [3, "value"], [1, "skeleton-list"], [1, "skeleton-row"], [1, "table-wrapper"], ["cdkDropList", "", 1, "data-table", 3, "cdkDropListDropped"], [2, "width", "40px"], [2, "width", "44px"], [2, "width", "90px"], ["cdkDrag", ""], ["cdkDragHandle", "", 1, "drag-cell", 3, "title"], ["width", "14", "height", "14", "viewBox", "0 0 14 14", "fill", "currentColor", 2, "color", "var(--app-text-3)", "cursor", "grab"], ["cx", "4", "cy", "3", "r", "1.2"], ["cx", "10", "cy", "3", "r", "1.2"], ["cx", "4", "cy", "7", "r", "1.2"], ["cx", "10", "cy", "7", "r", "1.2"], ["cx", "4", "cy", "11", "r", "1.2"], ["cx", "10", "cy", "11", "r", "1.2"], [1, "faixa-bolinha", 3, "title"], [1, "font-medium"], [2, "font-size", "12px", "color", "var(--app-text-2)"], [2, "display", "flex", "gap", "4px", "align-items", "center"], ["title", "Editar", 1, "icon-btn", 3, "click"], ["width", "14", "height", "14", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "viewBox", "0 0 24 24"], ["d", "M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"], ["d", "M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"], ["title", "Excluir", 1, "icon-btn", "icon-btn-danger", 3, "click"], ["points", "3 6 5 6 21 6"], ["d", "M19 6l-1 14H6L5 6"], ["d", "M10 11v6"], ["d", "M14 11v6"], ["d", "M9 6V4h6v2"], [1, "empty-state"], [1, "btn-primary", 3, "click"], [1, "modal-backdrop", 3, "click"], [1, "modal"], [1, "modal-header"], [1, "modal-close", 3, "click"], [1, "alert-error"], [1, "modal-body", 3, "ngSubmit", "formGroup"], [1, "form-row"], ["formControlName", "nome", 1, "form-input"], [1, "form-group", 2, "max-width", "100px"], ["formControlName", "cor", "type", "color", 1, "form-input", "color-input"], ["formControlName", "ordem", "type", "number", "min", "1", 1, "form-input"], ["formControlName", "requisitosMesesMinimos", "type", "number", "min", "0", 1, "form-input"], ["formControlName", "requisitosPresencasMinimas", "type", "number", "min", "0", 1, "form-input"], ["formControlName", "descricao", "rows", "2", 1, "form-input"], [1, "modal-actions"], ["type", "button", 1, "btn-secondary", 3, "click"], ["type", "submit", 1, "btn-primary", 3, "disabled"]], template: function FaixasComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(8, "+ Criar nova gradua\xE7\xE3o");
        \u0275\u0275elementEnd()()();
        ...
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(18, FaixasComponent_Conditional_18_Template, 3, 1, "div", 12)(19, FaixasComponent_Conditional_19_Template, 21, 1)(20, FaixasComponent_Conditional_20_Template, 3, 1)(21, FaixasComponent_Conditional_21_Template, 40, 5);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(7);
        ...
        \u0275\u0275advance(2);
        \u0275\u0275conditional(18, ctx.carregando() ? 18 : ctx.faixas().length > 0 ? 19 : 20);
        \u0275\u0275advance(3);
...
//# sourceMappingURL=chunk-E4DB4JMN.js.map
