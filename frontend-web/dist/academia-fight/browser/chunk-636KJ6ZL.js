...
function FuncionarioFormComponent_Conditional_7_For_38_Template(rf, ctx) {
  if (rf & 1) {
...
function FuncionarioFormComponent_Conditional_7_Conditional_39_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 24)(1, "label", 28)(2, "div", 29);
    \u0275\u0275element(3, "input", 30)(4, "span", 31);
    \u0275\u0275elementEnd();
...
function FuncionarioFormComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(37, FuncionarioFormComponent_Conditional_7_For_38_Template, 4, 2, "label", 23, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275template(39, FuncionarioFormComponent_Conditional_7_Conditional_39_Template, 6, 0, "div", 24);
    \u0275\u0275elementStart(40, "div", 25)(41, "a", 3);
    \u0275\u0275text(42, "Cancelar");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(39, ctx_r1.editandoId() ? 39 : -1);
    \u0275\u0275advance(4);
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FuncionarioFormComponent, selectors: [["app-funcionario-form"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 8, vars: 2, consts: [[1, "page-container"], [1, "page-header"], [1, "page-title"], ["routerLink", "/app/funcionarios", 1, "btn-secondary"], [1, "skeleton-list"], [1, "skeleton-row"], [1, "alert-error"], [1, "form-card", 3, "ngSubmit", "formGroup"], [1, "form-row"], [1, "form-group", 2, "flex", "2"], [1, "form-label"], ["formControlName", "nome", "placeholder", "Nome do funcion\xE1rio", 1, "form-input"], [1, "form-error"], [1, "form-group"], ["formControlName", "telefone", "placeholder", "(11) 99999-9999", "inputmode", "numeric", 1, "form-input", 3, "input"], ["formControlName", "email", "type", "email", "placeholder", "email@academia.com", 1, "form-input"], ["formControlName", "cargo", "placeholder", "Ex: Professor de Jiu-Jitsu", 1, "form-input"], ["formControlName", "perfil", 1, "form-input"], ["value", "Admin"], ["value", "Professor"], ["value", "Recepcionista"], [1, "form-section-title"], ["formGroupName", "permissoes", 1, "permissoes-grid"], [1, "perm-item"], [1, "form-group", 2, "margin-top", "16px"], [1, "form-actions"], ["type", "submit", 1, "btn-primary", 3, "disabled"], ["type", "checkbox", 3, "formControlName"], [1, "toggle-label"], [1, "toggle-switch"], ["formControlName", "ativo", "type", "checkbox"], [1, "toggle-slider"]], template: function FuncionarioFormComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(5, "\u2190 Voltar");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(6, FuncionarioFormComponent_Conditional_6_Template, 3, 1, "div", 4)(7, FuncionarioFormComponent_Conditional_7_Template, 45, 9);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
...
//# sourceMappingURL=chunk-636KJ6ZL.js.map
